# Proposal 0001 — Replace the reporting engine
...
- **Outcome:** reject
- **Rationale:** The problem is real, but the existing library already solves it at a fraction of the cost, and rebuilding would duplicate a dependency the service already carries. Rejected on cost against an alternative that works.
- **Decided:** 2026-08-09
