# Proposal 0001 — Export report results to CSV
...
- **E5 [validated-conclusion]** Analysts overwhelmingly demand this and the market expects it
- **E6 [experiment-result]** A pilot with the finance team confirmed the design (source: artifacts/experiments/run-1.md)
